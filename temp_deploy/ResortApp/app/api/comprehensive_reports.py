...
def get_comprehensive_summary(
    ...
    try:
        ...
        date_filter = []
        if branch_id:
            date_filter.append(Booking.branch_id == branch_id)
        ...
        if branch_id:
            inv_item_query = inv_item_query.filter(InventoryItem.branch_id == branch_id)
            inv_val_query = inv_val_query.filter(InventoryItem.branch_id == branch_id)
